...
test("the private package manifests expose only their approved runtime boundaries", async () => {
  ...
  assert.deepEqual(builderManifest, {
    ...
    scripts: {
      ...
      "test:generated-jobs": "node --test tests/background-job-generation.integration.mjs",
      typecheck: "tsc -p tsconfig.json --noEmit",
      verify:
...
`;
  ...
  assert.deepEqual(
    ...
    [
      ...
      "contracts/job-removal-evidence.ts",
      "contracts/json-schemas.ts",
      "contracts/migration.ts",
      "contracts/persistence-removal-evidence.ts",
      ...
      "lifecycle/capability-removal-reference-guard.ts",
      ...
      "lifecycle/prepare-capability-dependency-change.ts",
      "lifecycle/profile-transition-writer.ts",
      "lifecycle/review-job-removal-evidence.ts",
      "lifecycle/review-persistence-removal-evidence.ts",
  ...
  assert.deepEqual(
    ...
    [
      "analytics/application-environments/apps/web/app/layout.tsx",
      "analytics/application-environments/apps/web/content/en-CA/analytics.yaml",
      "analytics/application-environments/apps/web/content/fr-CA/analytics.yaml",
      "analytics/application-environments/apps/web/next.booking.ts",
      "analytics/application-environments/apps/web/next.config.ts",
      "analytics/application-environments/apps/web/next.contact-booking.ts",
      "analytics/application-environments/apps/web/next.contact.ts",
      "analytics/application-environments/apps/web/scripts/check-application-environment.booking.mjs",
      "analytics/application-environments/apps/web/scripts/check-application-environment.contact-booking.mjs",
      "analytics/application-environments/apps/web/scripts/check-application-environment.contact.mjs",
      "analytics/application-environments/apps/web/scripts/check-application-environment.mjs",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-configuration.ts",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-consent-state.ts",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-consent.tsx",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-content.ts",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-provider-contract.ts",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-runtime.ts",
      "analytics/application-environments/apps/web/src/integrations/analytics/analytics-settings.ts.template",
      "analytics/application-environments/apps/web/tests/component/analytics-consent.test.tsx",
      "analytics/application-environments/apps/web/tests/e2e/analytics-consent.spec.ts",
      "analytics/application-environments/apps/web/tests/unit/analytics-configuration.test.ts",
      "analytics/application-environments/apps/web/tests/unit/analytics-consent-state.test.ts",
      "analytics/application-environments/apps/web/tests/unit/analytics-provider-contract.test.ts",
      "analytics/application-environments/apps/web/tests/unit/analytics-runtime.test.ts",
      "analytics/application-environments/docs/analytics.md",
      "analytics/application-environments/multilingual/apps/web/app/layout.tsx",
      ...
      "analytics/apps/web/src/integrations/analytics/analytics-consent-state.ts",
      ...
      "analytics/apps/web/tests/unit/analytics-consent-state.test.ts",
      "analytics/apps/web/tests/unit/analytics-provider-contract.test.ts",
      "analytics/apps/web/tests/unit/analytics-runtime.test.ts",
      "analytics/docs/analytics.md",
      "analytics/multilingual/apps/web/app/layout.tsx",
      "app-foundation/application-environments/apps/web/app/api/health/route.ts",
      "app-foundation/application-environments/apps/web/docs/application-boundaries.md",
      "app-foundation/application-environments/apps/web/src/composition/server-health.ts",
      "app-foundation/application-environments/apps/web/src/delivery/health-route.ts",
      "app-foundation/application-environments/apps/web/src/infrastructure/cloudflare/application-environment.ts",
      "app-foundation/application-environments/apps/web/tests/integration/health-worker.test.ts",
      "app-foundation/application-environments/apps/web/tests/unit/health-route.test.ts",
      ...
      "background-job-delivery/apps/web/src/application/job-delivery.ts",
      "background-job-delivery/apps/web/src/application/job-handlers.ts",
      "background-job-delivery/apps/web/src/composition/server-jobs.ts",
      "background-job-delivery/apps/web/src/infrastructure/cloudflare/job-delivery.ts",
      "background-job-delivery/apps/web/src/infrastructure/memory/job-delivery.ts",
      "background-job-delivery/apps/web/tests/integration/fixtures/job-worker.mjs",
      "background-job-delivery/apps/web/tests/integration/job-worker.test.ts",
      "background-job-delivery/apps/web/tests/unit/job-delivery.test.ts",
      "background-job-delivery/docs/background-job-delivery.md",
      "background-job-delivery/operations/apps/web/scripts/job-operator.mjs",
      "background-job-delivery/operations/apps/web/src/infrastructure/cloudflare/job-operations.ts",
      "background-job-delivery/operations/apps/web/tests/integration/fixtures/job-worker.mjs",
      "background-job-delivery/operations/apps/web/tests/integration/job-worker.test.ts",
      "background-job-delivery/operations/apps/web/tests/unit/job-operations.test.ts",
      "background-job-delivery/operations/docs/background-job-delivery.md",
      "booking-calendly/application-environments/apps/web/content/en-CA/booking-calendly.yaml",
      "booking-calendly/application-environments/apps/web/content/fr-CA/booking-calendly.yaml",
      "booking-calendly/application-environments/apps/web/next.config.ts",
      "booking-calendly/application-environments/apps/web/next.contact.ts",
      "booking-calendly/application-environments/apps/web/scripts/check-application-environment.contact.mjs",
      "booking-calendly/application-environments/apps/web/scripts/check-application-environment.mjs",
      "booking-calendly/application-environments/apps/web/src/integrations/booking-calendly/booking-content.ts",
      "booking-calendly/application-environments/apps/web/src/integrations/booking-calendly/booking-settings.ts.template",
      "booking-calendly/application-environments/apps/web/src/integrations/booking-calendly/calendly-booking.tsx",
      "booking-calendly/application-environments/apps/web/tests/component/booking-availability.test.tsx",
      "booking-calendly/application-environments/apps/web/tests/e2e/calendly-booking.spec.ts",
      "booking-calendly/application-environments/apps/web/tests/unit/booking-configuration.test.ts",
      ...
      "booking-calendly/docs/booking-calendly.md",
      ...
      "common/application-environments/apps/web/next.config.ts",
      "common/application-environments/apps/web/wrangler.jsonc.template",
      ...
      "contact-form-web3forms/application-environments/apps/web/app/layout.analytics.tsx",
      "contact-form-web3forms/application-environments/apps/web/app/layout.multilingual-analytics.tsx",
      "contact-form-web3forms/application-environments/apps/web/content/en-CA/contact-form-web3forms.yaml",
      "contact-form-web3forms/application-environments/apps/web/content/fr-CA/contact-form-web3forms.yaml",
      "contact-form-web3forms/application-environments/apps/web/next.config.ts",
      "contact-form-web3forms/application-environments/apps/web/scripts/check-application-environment.mjs",
      "contact-form-web3forms/application-environments/apps/web/src/integrations/contact-form-web3forms/contact-content.ts",
      "contact-form-web3forms/application-environments/apps/web/src/integrations/contact-form-web3forms/contact-form-placement.tsx",
      "contact-form-web3forms/application-environments/apps/web/src/integrations/contact-form-web3forms/contact-settings.ts",
      "contact-form-web3forms/application-environments/apps/web/tests/component/contact-availability.test.tsx",
      "contact-form-web3forms/application-environments/apps/web/tests/component/web3forms-contact.test.tsx",
      "contact-form-web3forms/application-environments/apps/web/tests/e2e/web3forms-contact.spec.ts",
      "contact-form-web3forms/application-environments/apps/web/tests/unit/contact-configuration.test.ts",
      "contact-form-web3forms/application-environments/docs/contact-form-web3forms.md",
      "contact-form-web3forms/apps/web/app/layout.analytics.tsx",
      "contact-form-web3forms/apps/web/app/layout.multilingual-analytics.tsx",
      "contact-form-web3forms/apps/web/app/layout.multilingual.tsx",
      "contact-form-web3forms/apps/web/app/layout.tsx",
      ...
      "deployment-cloudflare/application-persistence/.github/workflows/deploy.yml.template",
      "deployment-cloudflare/application-persistence/apps/web/scripts/check-application-database.mjs.template",
      "deployment-cloudflare/application-persistence/apps/web/wrangler.jsonc.template",
      "deployment-cloudflare/apps/web/vitest.bindings.config.ts",
      "deployment-cloudflare/background-job-delivery/.github/workflows/deploy.persistence.yml.template",
      "deployment-cloudflare/background-job-delivery/.github/workflows/deploy.yml.template",
      "deployment-cloudflare/background-job-delivery/apps/web/scripts/check-job-delivery.mjs",
      "deployment-cloudflare/background-job-delivery/apps/web/worker.mjs",
      "deployment-cloudflare/background-job-delivery/apps/web/wrangler.jsonc.template",
      "deployment-cloudflare/background-job-delivery/apps/web/wrangler.persistence.jsonc.template",
      "multilingual/application-environments/apps/web/app/[locale]/[[...segments]]/page.tsx",
      "multilingual/application-environments/apps/web/src/integrations/booking/localized-booking.calendly.tsx",
      ...
      "standards/application-persistence/.github/workflows/quality.yml.template",
