...
test("accepted app architecture keeps the public recipe convergent and Effect selective", async () => {
  ...
  assert.match(
    programRoadmap,
    /\*\*Stop gate:\*\* Complete the current transition-planning candidate's required deterministic and generated-runtime verification[^\n]+exact four-image manifest before exclusive promotion[^\n]+independent requirements[^\n]+test-evidence reviews[^\n]+exact review packet before final-diff approval/iu,
  );
  assert.match(
    convergentProfileAdr,
