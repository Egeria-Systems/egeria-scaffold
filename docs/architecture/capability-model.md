...
That closure result belongs to the accepted historical catalog. On the production-site candidate, descriptor admission still passes but both closure policies intentionally refuse the task-linked pending `site-routing@0.4.0` subject until its separate certification succeeds.
