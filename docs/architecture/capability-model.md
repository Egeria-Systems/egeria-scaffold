...
Repository removal, deployment-observability configuration, credential revocation or rotation, provider-resource disposition, retained-data disposition, and source/provider/credential recovery are separate reviewed requirements. The current subject under [`certifications/capabilities.json`](../../certifications/capabilities.json) is exact `observability@0.3.0`, behavior-contract digest `sha256:24a3cb3361cd8f72a12a1926b512e087adb31ad120a62b70e06a68d9dcf90c99`, ordinary `pending`, empty evidence, and linked to a future private local restricted-error-diagnostics certification plan. No certification has run for that subject. The prior certified `observability@0.2.0` subject at `ee1e1df10fa2be2f09333efecd86de7f7a131d49` retains only historical evidence from the private protected-staging receipt; that exact prior subject cannot certify `0.3.0`. Current local/static/generated evidence establishes no deployed/provider receipt, retention, cleanup/recovery, durable delivery, production readiness, privacy completeness, visual quality, human accessibility, or WCAG-conformance proof.
