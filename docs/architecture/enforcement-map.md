...
| `INV-CAPABILITY-METADATA` | Every capability declares normalized delivery, state, removal, security, ownership, inference, migration, and verification metadata | actual for the six executable P1 Task 2 descriptors; remaining program catalog planned | `builder-core` schema and catalog contract tests | P1 |
