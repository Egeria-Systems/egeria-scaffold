# Application site routing certification receipt

**Certification capability:** `site-routing`
**Certification descriptor version:** `0.4.0`
**Certification behavior-contract digest:** `sha256:a8bd53e9b32546266efd3dde9dc96fc3914cb06e9e811b8bf96ebd42822e2dac`
...
Fresh app runtime and owning contracts exercise routing/navigation, crawl metadata, nested errors/not-found and supported page/navigation migration. Current compiled portfolio-to-app and site-to-app transitions verify the installed routing subject, transformed content, lockfile and state through production verification.

Review route/content/crawl metadata preservation plus redirects and navigation recovery. Only the implemented incoming app transitions and their verified refusal boundaries are included; no additional transition or automated recovery is claimed.
