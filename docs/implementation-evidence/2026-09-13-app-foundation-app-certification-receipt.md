# App foundation certification receipt

**Certification capability:** `app-foundation`
**Certification descriptor version:** `0.1.0`
**Certification behavior-contract digest:** `sha256:6d9cf389441064a96d2b47bb309becab37358fcc2952335feffae8720eb6f497`
...
The default and all-optionals app executions exercise request context, build information, Effect health delivery, cause/cancellation behavior and the generated whole-Worker integration. Source and build inspection checks the exact Effect pin and server-only import boundary.

Recover the exact Effect dependency, whole-Worker verification script, managed application source, builder-owned lockfile and state together. Foundation removal, app upgrades and back-transition remain unsupported.
