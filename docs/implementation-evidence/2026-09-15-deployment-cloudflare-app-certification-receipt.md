# deployment-cloudflare app certification receipt

**Certification capability:** `deployment-cloudflare`
**Certification descriptor version:** `0.3.0`
**Certification behavior-contract digest:** `sha256:fb2464553830b052428773286689dc91984d662bf999b267aefbcb66e045ed6e`
...
This receipt covers the retained default-app deployment subject `0.3.0`. PR #129 introduced the separate persistence-supporting `deployment-cloudflare@0.4.0` subject. Its admission record remains pending; this receipt supplies no evidence for that different descriptor or digest.
