# Multilingual application behavior certification receipt

**Certification capability:** `multilingual`
**Certification descriptor version:** `0.1.0`
**Certification behavior-contract digest:** `sha256:48a3ac0f39e8f356fbc9bc63b95f2d4fb7d334aee8cbef0726800ee10fbd9891`
...
The all-optionals fresh app and owning checks exercise locale-prefixed routing/negotiation, exact translation keys and parity, localized navigation and discovery. The current compiled app optional lifecycle covers addition/removal and the surviving-reference refusal with booking and analytics.

Application-owned locale catalogs must be preserved, and single-locale routing/discovery restoration and the closed booking/multilingual lifecycle are reviewed. Human linguistic quality and translation approval remain separate from these software behavior outcomes.
