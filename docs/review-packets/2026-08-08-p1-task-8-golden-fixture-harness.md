# P1 Task 8 Review Packet — Golden Fixtures and Build Harness

**Date:** 2026-08-08 (America/Toronto)

**Outcome:** PASS after evidence-backed repairs. Stop before Task 9.

**Implementation comparison:** `bcedd968fcc11c8a836068f939c016c0c030f352..08bca41ada747bb11b72aae9f544e0392796569e`
...
Canonical documentation and root verification scripts now describe the implemented subset. The permanent semantic-naming scanner is the sole live owner after equivalent duplicate linting was removed. The roadmap leaves P1 in review.
...
Revert `08bca41`, `4ec29b8`, `db8ff9d`, `79735f2`, `8238e0e`, and `b044709` in the listed order with focused revert commits, then rerun `verify:builder-kernel`. Revert the gate-artifact commit separately if this packet/evidence must be withdrawn.
