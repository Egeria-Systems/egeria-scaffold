...
**Development stream:** Automatic-CI Plan A is accepted at `main@368b9491fd2f813f83f1e456823d8c7546f6762c`. The separate `standards-certification` branch resumed only for Task 6D evidence renewal and preserves its prior head through descendant merge `d7c63b0aaa9bebd56c075f16f1e5d86519853698`. All eight outcomes passed at that one revision. Review and separate final-diff approval remain mandatory. This does not alter the isolated-worktree requirement for builder commands that transform generated client repositories.
...
**Current capability-certification tasks:** P2 Task 6B is the separate `observability@0.2.0` certification increment. Its [fresh-scaffold runner](../../scripts/certify-production-observability.mjs) passed the reviewed local outcome, while the [manual protected-staging workflow](../../.github/workflows/production-observability-certification.yml) and [provider receipt template](../implementation-evidence/production-observability-provider-receipt-template.md) are prepared but unexecuted. The exact `standards@0.3.0` subject remains `certified`; its [subject-bound local receipt](../implementation-evidence/2026-08-12-generated-unit-component-testing-certification-verification.md) and strict [`certifications/capabilities.json`](../../certifications/capabilities.json) binding now identify all eight independently reviewed outcomes at post-Plan-A descendant `d7c63b0aaa9bebd56c075f16f1e5d86519853698` without changing the subject, digest, status, attribution, or ancestry validator. Admission passes. Within the remaining observability task, protected-staging, provider/source, credentials, telemetry transmission, cleanup, certification transition, merge, and push remain unauthorized; transition and all-certified closure correctly remain open.
