...
**Development stream:** Task 6C is integrated at `main@12ecc73a8337ab12ece9dd3a6b2aec03f940383c`. Task 6D executes its separate certification increment on the isolated `standards-certification` branch/worktree under the [review and contribution protocol](../governance/review-and-contribution.md). This does not alter the isolated-worktree requirement for builder commands that transform generated client repositories.
