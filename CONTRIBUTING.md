...
Run `pnpm run verify:builder-kernel` for the complete approved builder kernel and current generated-content increment, including deterministic fixture regeneration and isolated fresh-install/lint/typecheck/Next/OpenNext verification. This command performs public-registry reads and local builds but does not preview, deploy, publish, or mutate a provider.
