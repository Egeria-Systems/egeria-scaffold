...
export const generatedFixtureContracts = Object.freeze([
  ...
  Object.freeze({
    identifier: "portfolio-contact-form",
    profile: "portfolio",
    projectName: "acme-portfolio-contact-form",
    displayName: "Acme Portfolio Contact",
    createArguments: createArguments({ profile: "portfolio", projectName: "acme-portfolio-contact-form", displayName: "Acme Portfolio Contact", contactFormWeb3Forms: contactSettings }),
    expectedCapabilitySettings: Object.freeze({ "contact-form-web3forms": contactSettings }),
    relativeRoot: "fixtures/generated/portfolio-contact-form",
    expectedFiles: Object.freeze([...portfolioFiles, ...contactFiles].sort(codePointCompare)),
    expectedCapabilities: Object.freeze(["standards", "content-files", "section-composition", "deployment-cloudflare", "observability", "contact-form-web3forms"]),
    expectedRecipeVersion: "0.11.0",
    expectedStandardsVersion: "0.5.0",
    expectedObservabilityVersion: "0.3.0",
    expectedContentFilesVersion: "0.4.0",
