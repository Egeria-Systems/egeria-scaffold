...
import { readCompiledAnalyticsConfiguration } from "./analytics-configuration";
...
function initialStatus(
  ...
  if (
    ...
    resolution.reason === "collection-context-changed"
  ) {
...
function AnalyticsConsentControl({
  ...
  const collectionDisabled = !configuration.ok ||
    !configuration.configuration.collectionEnabled ||
    !configuration.configuration.collectionAvailable;
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        ...
        {collectionDisabled ? (
          <p className="max-w-3xl text-muted">{content.collectionDisabledNotice}</p>
        ) : null}
      </div>
