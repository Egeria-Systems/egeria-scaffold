...
export const backgroundJobOperationFiles = Object.freeze([
  { identifier: "job-operator-command", path: "apps/web/scripts/job-operator.mjs", ownership: "managed" },
  { identifier: "job-operations-policy", path: "apps/web/src/infrastructure/cloudflare/job-operations.ts", ownership: "managed" },
  { identifier: "job-operations-tests", path: "apps/web/tests/unit/job-operations.test.ts", ownership: "managed" },
] as const);
...
function createDescriptors(
  ...
  return [
    ...
    ...((snapshot.standards === "0.5.0" || snapshot.standards === "0.6.0" || applicationEnvironments) ? [{
      ...
      requiredPackages: [],
      platformResources: [],
      externalDomains: ["api.web3forms.com", "hcaptcha.com", "*.hcaptcha.com"],
      contentSecurityPolicyContributions: ["connect-src https://api.web3forms.com https://hcaptcha.com https://*.hcaptcha.com", "script-src https://hcaptcha.com https://*.hcaptcha.com", "frame-src https://hcaptcha.com https://*.hcaptcha.com", "style-src https://hcaptcha.com https://*.hcaptcha.com"],
      browserStorage: ["provider-controlled-hcaptcha-storage"],
      dataClassifications: ["contact-name", "reply-email-address", "contact-message", "provider-held-submissions", "provider-network-and-abuse-signals"],
      retentionAssumptions: ["operator-reviewed-web3forms-and-hcaptcha-retention", "provider-held-submissions-and-mailbox-copies"],
      privilegedOperations: ["configure-provider-form-and-captcha-enforcement", "submit-contact-notification"],
      threatReviewLevel: "elevated",
      adapterSemanticRequirements: ["browser-only-fixed-origin", "public-form-identifier-not-secret", "explicit-captcha-activation", "acknowledgement-is-not-inbox-delivery", "single-attempt-bounded-response-and-deadline", "uncertain-acceptance-no-automatic-retry"],
      ...projectEvidencePoints([
        createFileEvidencePoint("contact-settings", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/contact-settings.ts", "managed"),
        createFileEvidencePoint("contact-content-types", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/contact-content-source.d.ts", "application-owned"),
        createFileEvidencePoint("contact-content", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/contact-content.ts", "application-owned"),
        createFileEvidencePoint("contact-form", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/contact-form.tsx", "application-owned"),
        createFileEvidencePoint("web3forms-contact", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/web3forms-contact.tsx", "application-owned"),
        createFileEvidencePoint("contact-form-placement", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/contact-form-placement.tsx", "application-owned"),
        createFileEvidencePoint("submit-contact", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/submit-contact.ts", "application-owned"),
        createFileEvidencePoint("contact-hcaptcha", "contact-form-web3forms", "apps/web/src/integrations/contact-form-web3forms/hcaptcha.tsx", "application-owned"),
        createFileEvidencePoint("contact-content-english", "contact-form-web3forms", "apps/web/content/en-CA/contact-form-web3forms.yaml", "application-owned"),
    ...
    ...(jobs ? [{
      ...
      version: jobOperations ? "0.2.0" : "0.1.0",
      deliveryMode: "hybrid",
      stateClassifications: ["repository-stateful", "external-stateful"],
      removalPolicy: "reviewed",
      dependencies: ["app-foundation"],
      ...
      privilegedOperations: ["dispatch-background-job", "consume-background-job", ...(jobOperations ? ["inspect-terminal-job", "replay-terminal-job", "observe-job-drain"] : [])],
      threatReviewLevel: "elevated",
      ...
      ...projectEvidencePoints([...backgroundJobFiles, ...(jobOperations ? backgroundJobOperationFiles : [])].map(({ identifier, path, ownership }) =>
        createFileEvidencePoint(identifier, "background-job-delivery", path, ownership))),
      verificationPlan: ["job-contracts", "native-queue-delivery", "retry-exhaustion-and-terminal-inspection", "duplicate-and-out-of-order-safety", "timeout-cancellation-and-private-diagnostics", "whole-worker-execution", ...(jobOperations ? ["exact-source-lifecycle", "reviewed-queue-disposition", "bounded-replay-and-drain", "uncertain-acknowledgement-resumption"] : ["fresh-generation-and-lifecycle-refusal"])],
      ...
      removalAndRecoveryRequirements: [...(jobOperations ? ["review-fresh-resource-and-consumer-evidence", "review-primary-inflight-delayed-and-terminal-disposition", "preserve-modified-handlers", "refuse-surviving-job-references"] : ["unsupported-lifecycle-refusal"]), "retain-queued-and-terminal-work", "operator-authorized-recovery", "separate-source-provider-and-queued-data-recovery"],
      ...(jobOperations ? { migrationPlanners: ["add-background-job-delivery-0-2-0", "remove-background-job-delivery-0-2-0"] } : {}),
    } as const] : []),
  ...
  const supportedSnapshot = applicationEnvironments
    ...
    (appFoundationSnapshot === undefined ||
      ...
      ? ({
          ...
          ...(supportedJobs ? { backgroundJobDelivery: jobsSnapshot, deploymentCloudflare: persistenceSnapshot === "0.1.0" ? "0.6.0" : "0.5.0" } as const : {}),
