...
- `portfolio` is a one-page public presence; `site` is a multi-page public website; `app@0.1.0` materializes exact `app-foundation@0.1.0` plus `site-routing@0.4.0` by default so it retains the complete production-site experience.
