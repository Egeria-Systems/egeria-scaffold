...
- The future generated app pins `effect@4.0.0-rc.112` directly and confines Effect to application, infrastructure, composition, and delivery server modules. Builder-core, CLI, domain, presentation, client, and content code remain Effect-free; the recipe, dependency, runtime, generated surfaces, transitions, fixtures, and certification are unimplemented until their separately approved increments.
